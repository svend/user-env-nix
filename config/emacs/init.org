...
Use DejaVu fonts. Larger font on macOS vs Linux.

#+begin_src emacs-lisp
(set-face-attribute 'default nil
                    :family "DejaVu Sans Mono"
                    :height (if (eq window-system 'ns) 150 110))
...
(use-package modus-themes
  ...
  (setq modus-themes-slanted-constructs t
        modus-themes-org-blocks 'grayscale ; gray background for org code blocks
...
(use-package project
  ...
  (add-to-list 'project-find-functions #'my-project-try-go)
  (add-to-list 'project-find-functions #'my-project-try-projectile)
