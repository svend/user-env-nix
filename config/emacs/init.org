...
(use-package modus-themes
  ...
  :init
  (setq modus-themes-mixed-fonts t ; esure things like org tables are fixed-pitch
        modus-themes-fringes nil ; disable grey vertical fringes
  ...
  (modus-themes-load-theme 'operandi))
#+end_src
