...
Enable smooth scrolling. (Disabled because the last line is cut off sometimes.)
...
(use-package notmuch
  ...
  ;; Notmuch remote setup (on all hosts except notmuch host)
  (when (not (string= system-name "shale"))
