...
(message (file-name-directory (file-truename load-file-name)))
(message (file-name-as-directory (file-name-directory (file-truename load-file-name))))
(when load-file-name
  (add-to-list 'custom-theme-load-path
               (file-name-as-directory (file-name-directory (file-truename load-file-name)))))
#+end_src
